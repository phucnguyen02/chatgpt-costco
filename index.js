...
app.post("/chat", async (req, res) => {
    ...
    let messageType = parseInt(chatCompletion.choices[0].message.content.Message_Type);
    if(messageType == 4){
    ...
    switch(messageType){
        ...
        case 1:
            ...
            Please give me a response with a JSON format with the following fields: Station_Name, Address, City, State, Approximate_Distance, Regular_Gas, Premium_Gas.
        ...
        case 2:
            ...
            messageContent = `I am a user who is trying to refuel their car in Orange County or a nearby location, and my current address is X
            My current car brand is ${carBrand}. You are an advanced search engine, give me the appropriate gas type for my car and a
            ...
            Please give me a response with a JSON format with the following fields: Station_Name, Address, City, State, Recommended_Gas, Gas_Price.
